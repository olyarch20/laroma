...
;(function($){
    ...
    var bindToClass      = 'hover-carousel',
        containerWidth   = 0,
        scrollWidth      = 0,
    ...
    $.fn.carousel = function(options){
        $(document)
            .on('mouseenter.hover-carousel', '.' + bindToClass, calc)
            .on('mousemove.hover-carousel', '.' + bindToClass, move);
    };
...
$('.nav-link').click(function (el) {
    if(window.location.pathname !== '/index.html')
        window.location = '/index.html#' + el.target.id
});